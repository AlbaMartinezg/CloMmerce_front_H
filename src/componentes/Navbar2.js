...
//se intala esta extensión // Es7+React/Redux/React/React-Native/js -- en seguida dentro del archivo en blanco se escribe => este comando "rafce" y sale toda la finción sintener que digitarla
...
const Navbar2 = () => {
  ...
  <nav class="header-links contents font-semibold text-base lg:text-lg">
    <ul class="flex items-center ml-4 xl:ml-8 mr-auto">
      ...
      <li class="p-3 xl:p-6">
        <a href="/view-categorias" className="text-2xl font-light px-3 py-2 text-white rounded-lg hover:bg-fuchsia-900 hover:text-slate-300">
          <span>Categorías</span>
        </a>
      </li>
      <li class="p-3 xl:p-6">
        <a href="/view-productos" className="text-2xl font-light px-3 py-2 text-white rounded-lg hover:bg-fuchsia-900 hover:text-slate-300">
          <span>Productos</span>
        </a>
      </li>
      <li class="p-3 xl:p-6">
        <a href="/contactenos" className="text-2xl font-light px-3 py-2 text-white rounded-lg hover:bg-fuchsia-900 hover:text-slate-300">
  ...
  <nav class="hidden xl:contents">
    <ul class="flex items-center mr-4 lg:mr-6 xl:mr-8">
      <li class="p-1">
        <a href="https://www.facebook.com/CloMmerce" className="inline-block rounded-full border p-2 hover:shadow-lg hover:border-opacity-0 duration-200 hover:-translate-y-0.5">
        <img className="w-auto h-12" src={facebook}/>
        </a>
      </li>
      <li class="p-1">
        <a href="https://www.instagram.com/fasynga/" class="inline-block rounded-full border p-2 hover:shadow-lg hover:border-opacity-0 duration-200 hover:-translate-y-0.5">
        <img className="w-auto h-12" src={instagram}/>
        </a>
      </li>
      <li class="p-1">
        <a href="https://wa.me/573114856410" class="inline-block rounded-full border p-2 hover:shadow-lg hover:border-opacity-0 duration-200 hover:-translate-y-0.5">
      ...
      <li class="p-1">
        <a href="" className="inline-block rounded-full border p-2 hover:shadow-lg hover:border-opacity-0 duration-200 hover:-translate-y-0.5">
          <svg class="h-4" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="svg-inline--fa fa-instagram fa-w-14 fa-9x"></svg>
        </a>
      </li>
    </ul>
  </nav>
  <a href="" target="_blank" rel="noopener noreferrer" className="text-white hover:text-slate-300 px-3 py-2">
    <img className="w-auto h-12" src={instagram}/>
  </a>
